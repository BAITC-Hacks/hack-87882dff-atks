...
def create_app(snapshot=None, agent_client=None):
    ...
    def health():
        ...
        try:
            ...
            return HealthResponse(status='degraded', agent_available=available, metadata={'pipeline_ready': False})
        m = snapshot.metadata
        return HealthResponse(status='ok', agent_available=available, metadata={
