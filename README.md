...
> Qoyma -система для прогнозирования спроса и автоматического расчёта заказов поставщикам.
...
Qoyma — интеллектуальная система управления пополнением складских запасов.
